...
def fieldHeadings():
    fieldDict = {'Time of Infection': 1, 'Time of reporting': 2, 'x location': 3, 'y location': 4, 'Age': 5,
                 'Diabetes': 6, 'Respiratory Illnesses': 7, 'Abnormal Blood Pressure': 8, 'Outcome': 9}
    return fieldDict
